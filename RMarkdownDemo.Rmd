...
The `knitr` package has lots of options explained [here](http://yihui.name/knitr/options#chunk_options) in detail. 
...
opts_chunk$set(background='gray80', tidy=FALSE, cache=FALSE, comment='',
               dpi=200, fig.path='RMDfigs/', fig.width=4, fig.height=4)
```
